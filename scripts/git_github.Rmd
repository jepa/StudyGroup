...
If you are ready to make the documents worked on the alternative branch the main ones of your project you need to merge the alternative branch to the main one. Merging branches are a two way steps, i) there is a merge request and a ii) merge confirmation.

#### Merge request

You can see how many branches you have in the github.com page of your project. 

![In this case, the project has two branches]()

If you click in `branches`, you will see all the active branches, the commits that each one has, and a button that says "New pull request"

![List of branches showing the new pull request]()

I you click in the name of the branch, it will take you to the project within that branch.
